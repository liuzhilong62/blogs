...
![Insert image description](/img/csdn/c920095c8db9.png)


Re-examination content:
![Insert image description](/img/csdn/743ea585843c.png)
...
## How to Register
The two most important websites in the graduate exam process are your target school's official website and the China Graduate Admission Website, YanZhaoWang (YZW).
![Insert image description](/img/csdn/85579cc5cd7e.png)
...
![Insert image description](/img/csdn/3a5abec906cf.png)
...
So, my weekly plan:
![Insert image description](/img/csdn/8b233995a8b3.png)
...
### Recommended Study Materials
 - English: Zhang Jian's Yellow Book. Just buy the vocabulary book and past exam papers. Baicizhan (vocabulary app), iReading, WeChat public account: Graduate English Foreign Journals (English journals for grad exam prep).
...
![Insert image description](/img/csdn/63e6fcbbd3e9.png)

When memorizing, open it, zoom in — effectively covering the definitions while memorizing.
![Insert image description](/img/csdn/63e6b5373162.png)
...
#### Reading
English total score: 100. Reading ability components = Cloze 10 points + Reading Comprehension 40 points + New Question Type Reading 10 points = 60 points. No matter how poor your English ability, reading comprehension cannot be weak. My reading ability mostly came from daily foreign journal reading, such as iReading and Graduate English Foreign Journals. About 20 minutes a day, light study pressure. (Actually, it's mainly vocabulary — if you know the words, sentences are easy to understand.)
 ...
 - WeChat public account: Graduate English Foreign Journals, one passage a day. Updated daily. This account is very well done, highly recommended. Just harder — good for later-stage challenge. If you don't fully understand, that's fine; I sometimes couldn't fully grasp it either, since the difficulty is a bit high.
...
Dear  Sir or Madam,
    ...
    3.The last on I must point out is that Simple sentences,which could be accepted by the majority of people/.
...
```shell
1.Thank-you letter:expressing my genuine gratitude for your kind help
2.Suggestion letter:making some suggestions concerning sth.
3.Complaint letter:making my complaints concerning sth.
4.Congratulation letter:show my sincere congratulations to you because sentence
5.Apology letter:offer my sincere apology to you because sentence
6.Invitation letter:invite you to participate in event on behalf of someone/organization
7.Notification letter:have someone informed that sentence
```
...
```shell
    ...
    The event will be held in the school auditorium at 7 p.m.,next Saturday,December 28th and the requirements for sth. are listed as follows.

    Body content same as letter...
...
```shell 
    (Comparison opening)The diagram clearly shows/illustrates/d that sentence/phrase(the purposes of/attitudes toward/the proportions of) among participants/respondents in a certain college.
Based on the data offered,one can distinctly see that object1 ranks the first/highest among all the categories,accounting for data1.Next are object2 and object3 with data2 and
data3 respectively ,while object4 only constitutes data4.
    (Trend opening)The diagram clearly illustrates how topic changed during the past several years.Based on the data provided,one can distinctly see that the number of object1 rose/fell significantly/slightly/gradually from data in year to data in year,while that the number of object2 experienced a gradual/significant increase/decrease during the same period,reaching data in year.
    From my standpoint,there are two fundamental factors that are responsible for this scence.To begin with,the first contributing factor is that sentence.In addition,another important factor that cannot be ignored is that sentence.
    In view of the analysis above,we can conclude that it is of little surprise to see this phenomenon in the current era.Therefore,it can be predicted that noun phrase/verb-ing will still take up a large share in the future.
```
...
#### Math questions:
![Insert image description](/img/csdn/e16c5ab94d30.png)



#### Logic questions:
![Insert image description](/img/csdn/bc084fe7654f.png)
...
![Insert image description](/img/csdn/afd22229a49a.png)
