...
1. "DDIA-v2: Designing Data-Intensive Applications (2nd Edition)" — so good I don't know where to begin. So excellent that I specially wrote [reading notes](https://github.com/liuzhilong62/blogs/blob/main/Reading Notes/Reading Notes——DDIA-v2%20设计数据密集型应用（第二版）.md) (my only book notes article this year). I wish I had found it sooner.
